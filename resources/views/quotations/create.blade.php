                    ...
                    <div id="search-mode-fields" class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="customer_name" id="customer_name"
                                   ...
                                   placeholder="Auto-filled on selection" value="{{ old('customer_name') }}" required readonly>
                            @error('customer_name')
                        ...
                        <!-- Quotation No -->
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-bold">Quotation No (Auto)</label>
                            <input type="text" class="form-control bg-light fw-bold text-secondary" value="{{ $nextQuotationNo }}" readonly>
                        </div>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <textarea name="customer_address" id="customer_address" rows="1"
                                      class="form-control @error('customer_address') is-invalid @enderror field-autofilled"
                                      placeholder="Auto-filled on selection" readonly>{{ old('customer_address') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="discount" id="discount" class="form-control form-control-lg fw-bold text-danger" value="0.00" required>
                            </div>
                            @error('discount')
...
$(document).ready(function() {
    ...
    $('#mobile_search').on('select2:select', function(e) {
        ...
        // Make fields editable so user can override
    ...
    // Form submit guard — validate customer fields manually
    $('#quotation-form').on('submit', function(e) {
        const isNewMode = !$('#new-mode-fields').hasClass('d-none');

        if (isNewMode) {
            // Sync final values before validation
    ...
    $(document).ready(function() {
        // (customer select2 already initialized above)
