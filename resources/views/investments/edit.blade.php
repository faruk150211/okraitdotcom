    ...
    <div class="col-lg-7">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-0">
                <h5 class="card-title text-dark mb-0"><i class="bi bi-pencil me-2 text-warning"></i>Edit Investment</h5>
            </div>
            <form action="{{ route('investments.update', $investment->id) }}" method="POST">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0.01" name="amount" id="amount"
                                   ...
                                   value="{{ old('amount', number_format($investment->amount, 2, '.', '')) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="investment_date" id="investment_date"
                               ...
                               value="{{ old('investment_date', $investment->investment_date->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="source" id="source" class="form-select @error('source') is-invalid @enderror" required>
                            ...
                            <option value="{{ $src }}" {{ old('source', $investment->source) == $src ? 'selected' : '' }}>{{ $src }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                                  class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $investment->notes) }}</textarea>
                ...
                <div class="card-footer bg-white border-top py-3 d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-warning"><i class="bi bi-save me-1"></i> Update Investment</button>
                </div>
            </form>
        </div>
    </div>
