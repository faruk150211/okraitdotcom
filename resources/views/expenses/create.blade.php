    ...
    <div class="col-lg-7">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-0">
                <h5 class="card-title text-dark mb-0"><i class="bi bi-receipt-cutoff me-2 text-danger"></i>New Expense Entry</h5>
            </div>
            <form action="{{ route('expenses.store') }}" method="POST">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="title" id="title"
                               ...
                               placeholder="e.g. Office Rent August" value="{{ old('title') }}" required>
                ...
                <div class="card-footer bg-white border-top py-3 d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-danger"><i class="bi bi-save me-1"></i> Save Expense</button>
                </div>
            </form>
        </div>
    </div>
